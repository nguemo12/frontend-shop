...
const NewStore = ({ inputs, title }) => {
  ...
  const addContact = async (data)=>{
    ...
    const response = await axios.post("http://localhost:7070/api/store",data);
          ...
          <div className="right">
            <form onSubmit={handleSubmit}  >
              ...
              <div className="formInput" >
                  ...
                  <input type="text" onChange={(e)=> (setData({...data,store_name: e.target.value}))} placeholder="name" value={data.store_name}  />
                  ...
                  <label>Country</label>
                  <input type="text" onChange={(e)=> (setData({...data,state: e.target.value}))} placeholder="Am" value={data.state}  />
